...
/**
 * 仿小米时钟  https://blog.csdn.net/qq_31715429/article/details/54668668
 */
public class MiClockView2 extends View {
    ...
    public MiClockView2(Context context) {
        this(context, null);
    }

    public MiClockView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MiClockView2(Context context, AttributeSet attrs, int defStyleAttr) {
